  ...
  <div class="copyright-wrapper">
    <div class="container">
      <div class="copyright-txt">
        ...
        <?php } ?>
        <?php bloginfo('name'); ?>
        <?php esc_html_e('Theme By ','skt-juice-and-shakes-lite');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/restaurant/');?>" target="_blank"><?php esc_html_e('SKT Restaurant Themes','skt-juice-and-shakes-lite'); ?></a>        
      </div>
      <div class="clear"></div>
    </div>
  </div>
